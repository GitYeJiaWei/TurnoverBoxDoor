...
public class ExcelUtils {
    ...
    private final static String[] mContent = new String[]{"ID", "EPC", "PC",
            AppApplication.getApplication().getResources().getString(R.string.real_list_times),
            "RSSI",AppApplication.getApplication().getString(R.string.real_list_freq)};
